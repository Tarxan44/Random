class dictionary():
    def dictionary():
      ...
      { 
          ...
          """ NOTE: Because of the dictionary setup, the four primary categories: [ Property, Expenses/Income, 'Clothing, Fabric, Accessories', Other ] are all Level 1 Categories, 
                and need to be assigned at the moment of column (level[#]) assignment"""
         ...
         'level_data': [ 
               ...
               {  """Begin Clothing, Fabric, Accessories"""
                  'level': 2,
               ...
               }, """End Clothing, Fabric, Accessories"""
               {  """Begin Other"""
                  'level': 2,
                  'level_name': 'Other',
